...
public class PerfilController {
    ...
    @GetMapping
    @RequiresPermission(telaNom = "Perfil", acaoNom = "Consultar")
    ...
    @DeleteMapping("/{id}")
    @RequiresPermission(telaNom = "Perfil", acaoNom = "Excluir")
